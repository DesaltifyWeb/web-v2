    ...
    return (
      <div className='sm:pt-36 pt-16'>
        <div class="space-y-12">
            <div className='bg-oxford text-plat flex justify-center lg:px-18 sm:px-12 px-6 py-24 pb-20 sm:text-left'>
                <div className='lg:w-[84rem] pb-20'>
                  <h1 className='text-center sm:text-7xl font-mont font-bold text-4xl px-12'>Contact Us</h1>
                    ...
                    <form ref={form} onSubmit={sendEmail} className="bg-plat p-8 rounded-lg shadow-lg w-full scale-75 md:scale-100 lg:w-[65rem] font-medium">
                        <div className="mb-4">
                            <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2">
                                <input className="appearance-none border w-full py-2 px-3 text-oxford leading-tight focus:outline-none focus:shadow-outline"
                                    type="text" 
                        ...
                        <div className="mb-6">
                            <textarea className="appearance-none border w-full py-2 px-3 text-oxford leading-tight focus:outline-none focus:shadow-outline"
                                name='message'
                        ...
                        <div>
                            <button className="px-4 py-2 bg-oxford text-silver hover:bg-yinmin font-mont font-semibold text-xl" type="submit">Submit</button>
                        </div>
                    </form>
                  </div>
                </div>
