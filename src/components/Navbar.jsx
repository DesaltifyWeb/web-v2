            ...
            <div className='py-1 sm:py-2 px-2 sm:px-8'>
                <div className="flex justify-between items-center">
                    <div className="flex items-center">
                        ...
                        <div className='font-alice font-medium text-plat text-2xl sm:text-5xl pt-4'>
                            <h1>Desaltify</h1>
                        </div>
                    </div>
                    {isMobile ? (
                        ...
                        <div className="flex items-center space-x-8 sm:space-x-12 font-mont text-2xl text-plat pt-4">
                ...
                {isOpen && (
                    <div className="mobile-menu mt-4 bg-night text-plat text-lg font-mont">
