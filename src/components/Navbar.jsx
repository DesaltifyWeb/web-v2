    ...
    return (
        <div className="bg-night max-w-full fixed top-0 z-50 w-full pb-3">
            <div className='py-1 sm:py-2 px-2 sm:px-8'>
                <div className="flex justify-between items-center">
                    <div className="flex items-center">
                        ...
                        <div className='font-alice font-medium text-white text-2xl sm:text-5xl pt-4'>
                            <Link to='/' className='hover:text-silver ease-in duration-150'><h1>Desaltify</h1></Link>
                        </div>
                    </div>
                    {isMobile ? (
                        ...
                        <div className="flex items-center space-x-8 sm:space-x-12 font-mont text-2xl text-white pt-4 font-medium">
                            <Link to='/' className='hover:text-silver ease-in duration-150'>Home</Link>
                            <Link to='/meet' className='hover:text-silver ease-in duration-150'>Meet The Team</Link>
                            <Link to='/contact' className='hover:text-silver ease-in duration-150'>Contact Us</Link>
                ...
                {isOpen && (
                    <div className="mobile-menu mt-4 bg-night text-white text-lg font-mont font-medium">
